...
`;
  ...
  static get properties() {
    ...
    _onModelGetFailed(e){
        this.logError("rock-entity-graph-tree - Model get response error", e.detail);
    }
    ...
    _onOwnedDataSourceError(ev){
        this.logError("rock-entity-graph-tree - owned data source error ", ev.detail);
    }

    _onWhereUsedDataSourceError(ev){
        this.logError("rock-entity-graph-tree - where used data source error ", ev.detail);
