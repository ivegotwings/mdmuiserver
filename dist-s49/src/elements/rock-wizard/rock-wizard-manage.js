                ...
                <div class="stepper-wrapper">
                    ...
                    <template is="dom-if" if="[[showNavigationButtons]]">
                        <div id="content-actions" class="navigation-buttons" align="center">
                            ...
                            <pebble-button class="action-button-focus dropdownText btn btn-outline-primary" id="next" hidden\$="[[hideNext]]" disabled\$="[[disableNext]]" button-text="Next" raised="" on-tap="_onNextTap"></pebble-button>
                        </div>
                    </template>
                </div>
            </div>
