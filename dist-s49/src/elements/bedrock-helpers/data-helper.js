...
DataHelper.sortingFunction = function (sortData) {
        ...
        if (this.sortData.fields.length) {
            ...
            */
            ...
            if (i < this.sortData.fields.length) {
                ...
                */
                const a1 = (typeof a[this.sortData.fields[i]] === "string") ? a[this.sortData.fields[
                    i]].toLowerCase() : a[this.sortData.fields[i]];
                const b1 = (typeof b[this.sortData.fields[i]] === "string") ? b[this.sortData.fields[
                    i]].toLowerCase() : b[this.sortData.fields[i]];
