...
`;
    ...
    _onDimentionAttributeListGetFailed(e) {
        this.logError("Unable to fetch variant attributes list. Contact administrator for further detail.", e.detail);
        this.isSpinnerActive = false;
    }
    ...
    _onEntityGovernResponse(e) {
        if (e && e.detail && e.detail.response && e.detail.response.response && e.detail.response.response
            ...
            this.logError("AttributeManageValidationFail:- There is a problem in validation service. Contact administrator for further detail.", e.detail);
        }
    }
