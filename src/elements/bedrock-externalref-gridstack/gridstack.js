...
(function(factory) {
    ...
    var Utils = {
        ...
        createStylesheet: function(id, container) {
    ...
    */
    ...
    var GridStack = function(el, opts) {
        ...
        this.container = $(el);
        this.rootNode = opts.rootNode ? opts.rootNode : null;
    ...
    GridStack.prototype._initStyles = function() {
        if (this._stylesId) {
            Utils.removeStylesheet(this._stylesId, this.container, this.rootNode);
        }
        this._stylesId = 'gridstack-style-' + (Math.random() * 100000).toFixed();
        this._styles = Utils.createStylesheet(this._stylesId, this.container);
