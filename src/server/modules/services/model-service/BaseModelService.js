                ...
                switch(rel.toLowerCase()) {
                    ...
                    case "hasrelationshipattributes":
                        if(attrAndRelModels.attributes) {
                            ...
                            relationships[rel.toLowerCase()] = this._prepareRelationships(attrAndRelModels.attributes, "attributeModel")
                        }
                        break;
