...
class RockAttributeMappingGrid
  ...
  static get template() {
    return html`
        <style include="bedrock-mapping-grid-style bedrock-style-tooltip bedrock-style-grid-layout bedrock-style-floating bedrock-style-icons bedrock-style-padding-margin bedrock-style-buttons">
            :host{
                display: block;
                height: 100%;
            }
