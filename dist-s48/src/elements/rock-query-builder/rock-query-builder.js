        ...
        <div class="queryBuilderContainer">
            <paper-card>
                ...
                <div class="card-content p-r-20 p-l-20">
                    ...
                    <!-- filter options -->
                    <rock-attribute-filter-popover id="rockfilter" context-data="[[contextData]]" attribute-values-exists-search-enabled="[[_isAttributeValuesExistsSearchEnabled]]"></rock-attribute-filter-popover>
