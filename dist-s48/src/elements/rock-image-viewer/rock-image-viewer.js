  ...
  static get template() {
    return html`
        ...
        <template is="dom-if" if="[[_isAssetViewerOpened]]">
            <pebble-dialog id="pebbleModal" opened="" on-tap="_onTapPopover" dialog-title="[[assetDetails.property_originalfilename]]" modal="" horizontal-align="auto" vertical-align="auto" enable-drag="" show-close-icon="" no-cancel-on-outside-click="" no-cancel-on-esc-key="">
