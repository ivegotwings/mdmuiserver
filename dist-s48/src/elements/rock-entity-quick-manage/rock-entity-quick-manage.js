...
class RockEntityQuickManage extends mixinBehaviors([RUFBehaviors.UIBehavior,
  ...
  static get template() {
    return html`
        <style include="bedrock-style-common bedrock-style-tooltip bedrock-style-grid-layout bedrock-style-icons bedrock-style-padding-margin bedrock-style-flex-layout">
            :host {
                display: block;
                height: 100%;
            }
