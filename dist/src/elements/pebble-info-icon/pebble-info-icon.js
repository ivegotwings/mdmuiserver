  ...
  static get template() {
    return Polymer.html`
        ...
        <template is="dom-if" if="[[_items.length]]">
            <div class="description-image-wrapper" id="show-description-icon" on-mousedown="_showDescription" on-tap="_showDescription">
                &nbsp;&nbsp;
...
`;
  ...
  _showDescription(e) {
      let description = this.shadowRoot.querySelector("#description-popover");
      if (description) {
          description.show();
      }
      e.stopPropagation();
