...
`;
  ...
  */
  ...
  _onGetSearchResponse (success, error) {
      if (typeof (this.rDataFormatter) == 'function' && !_.isEmpty(this.getEntitySearchResultsResponse)) {
          if (this.getEntitySearchResultsResponse.status === "success") {
              success(this.rDataFormatter(this.getEntitySearchResultsResponse));
          } else {
              let detail = {
                  request: this.request,
                  response: this.getEntitySearchResultsResponse
              }
