    ...
    <div id="rockTitle" class="header">
        ...
        <div class="pull-right">
            ...
            <template is="dom-if" if="[[!nonMinimizable]]">
                <pebble-icon id="minimize" class="minimize pebble-icon-color-blue pebble-icon-size-12 m-l-5 tooltip-bottom" name="minimize" data-tooltip="Minimize" icon="pebble-icon:window-action-minimize" on-tap="_onMinimize"></pebble-icon>
            </template>
