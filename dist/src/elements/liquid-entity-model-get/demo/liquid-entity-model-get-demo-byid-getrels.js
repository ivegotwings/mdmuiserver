...
Polymer$0({
  _template: html`
        ...
        <liquid-entity-model-get id="entityGetData4" verbose="" operation="getbyids" request-id="req2" request-data="{{request2}}" last-response="{{entities2}}"></liquid-entity-model-get>
`,

  is: 'liquid-entity-model-get-demo-byid-getrels',
              ...
              return {
                  "params": {
                      "query": {
                          "contexts": [
                              {
                                 "self": "self/sku_ruleContextMappings",
