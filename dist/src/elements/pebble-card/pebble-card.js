                        ...
                        <div class="card-icons">
                            <template is="dom-if" if="[[_cardIconButtons]]">
                                <template is="dom-repeat" items="[[_cardIconButtons]]">
                                    <pebble-icon name="[[item.name]]" class="pebble-icon-size-16 pebble-icon-color-grey tooltip-bottom" icon="[[item.icon]]" on-tap="_onIconButtonClick" data-tooltip="Refresh" noink="">
                                    </pebble-icon>
                                </template>
                            </template>
                            ...
                            <template is="dom-if" if="[[!nonClosable]]">
                                <pebble-icon name="remove" icon="pebble-icon:governance-failed" class="pebble-icon-size-16 pebble-icon-color-grey" title="Remove" on-tap="_onRemoveClick">
                            </pebble-icon></template>

                            <template is="dom-if" if="[[_isMoreButtonsAvailable(_moreIconButtons)]]">
                                <pebble-icon id="actionButton" on-tap="_onActionsButtonTap" icon="pebble-icon:actions-more-vertical" class="dropdown-trigger m-l-5 tooltip-bottom pebble-icon-size-12" noink="" data-tooltip="More">
                                </pebble-icon>
