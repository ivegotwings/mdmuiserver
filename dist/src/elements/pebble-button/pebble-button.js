...
class PebbleButton
  ...
  static get template() {
    return Polymer.html`
        ...
        <template is="dom-if" if="[[menuButton]]">
            <paper-menu-button id="menuButton" tabindex\$="[[tabindex]]" allow-outside-scroll="[[allowOutsideScroll]]" dynamic-align="[[dynamicAlign]]" horizontal-align="[[horizontalAlign]]" vertical-align="[[verticalAlign]]" horizontal-offset="[[horizontalOffset]]" vertical-offset="[[verticalOffset]]" disabled="[[disabled]]" no-animations="[[noAnimations]]" no-overlap="[[noOverlap]]">
                <paper-button id="button" tabindex="-1" class="dropdown-trigger" elevation="[[elevation]]" noink="[[noink]]" toggles="[[toggles]]" disabled="[[disabled]]" slot="dropdown-trigger">
                    <template is="dom-if" if="[[_computeIconButton(icon,buttonText)]]">
