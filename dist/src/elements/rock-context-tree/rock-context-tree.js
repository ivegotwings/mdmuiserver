...
class RockContextTree extends mixinBehaviors([RUFBehaviors.UIBehavior, RUFBehaviors.ComponentContextBehavior, RUFBehaviors.ComponentConfigBehavior], OptionalMutableData(PolymerElement)) {
  static get template() {
    return html`
        ...
        <liquid-entity-data-get id="initGetEntitySearch" operation="initiatesearch" request-data="[[request]]" on-response="_initContextSearchResponse" on-error="_onGetSearchError" exclude-in-progress=""></liquid-entity-data-get>
        <liquid-entity-data-get id="getEntitySearchResults" operation="getsearchresultdetail" request-data="[[request]]" on-response="_getContextSearchResultResponse" on-error="_onGetSearchError" exclude-in-progress="" include-type-external-name=""></liquid-entity-data-get>
`;
  }
