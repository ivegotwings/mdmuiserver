    ...
    return Polymer.html`
        ...
        <pebble-popover id="filterPopover" for="" no-overlap="" vertical-align="auto" horizontal-align="right">
                ...
                <template is="dom-if" if="{{_showTagModifier('textbox',currentFilterObj.displayType)}}">
                    <pebble-textbox-collection id="textCollection" values="{{txtBoxCollection}}" no-popover="" textbox-label="Enter values to search" show-seperator="" seperator="or" disabled="[[!currentFilterObj.attributeHasValueChecked]]"></pebble-textbox-collection>
                ...
                <paper-radio-button name="equalToData" disabled="[[!currentFilterObj.attributeHasValueChecked]]">
                    ...
                    <pebble-textbox-collection id="textNumericCollection" values="{{_tagsNumericCollection}}" no-popover="" textbox-label="Enter values to search" show-seperator="" seperator="or" allowed-pattern="[0-9.]" text-collection-input="{{_tagNumericInput}}"></pebble-textbox-collection>
                    </div>
                    <div class="clearfix"></div>
                </paper-radio-button>
                </paper-radio-group>
