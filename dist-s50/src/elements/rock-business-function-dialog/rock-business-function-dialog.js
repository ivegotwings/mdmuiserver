...
class RockBusinessFunctionDialog extends mixinBehaviors([RUFBehaviors.UIBehavior, RUFBehaviors.BusinessFunctionBehavior, RUFBehaviors.ComponentConfigBehavior], PolymerElement) {
  static get template() {
    return html`
        ...
        <bedrock-pubsub on-bedrock-event-on-buttonclose-clicked="_closeDialog" name="bedrock-event-on-buttonclose-clicked"></bedrock-pubsub>
`;
  }
  ...
  _closeDialog(e, detail) {
      let ignoreDirtyCheck = detail && detail.ignoreDirtyCheck;
      if (this.getIsDirty() && !ignoreDirtyCheck) {
